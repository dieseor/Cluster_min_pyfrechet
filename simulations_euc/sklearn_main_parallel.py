...
data_dir = os.path.join(os.getcwd(), 'simulations_euc', 'pb_25')
results_dir = os.path.join(os.getcwd(), 'simulations_euc', 'results')
os.makedirs(results_dir, exist_ok=True)

# By-blocks execution
n_samples=len(os.listdir(os.path.join(os.getcwd(), 'simulations_euc/' 'pb_25')))
...
file_list = list(filter(lambda file: file.endswith(f'block_{current_block}.pkl'), filter(lambda file: file.endswith('.pkl'), os.listdir(os.path.join(os.getcwd(), 'simulations_euc', 'pb_25/')))))
