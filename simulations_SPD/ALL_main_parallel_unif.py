...
# By-blocks execution
n_samples=len(os.listdir(os.path.join(os.getcwd(), 'simulations_SPD', 'data_unif')))
...
def task(file) -> None:
    ...
    with open(os.path.join(os.getcwd(), 'simulations_SPD', 'data_unif/' + file), 'rb') as f:
    ...
    with open(os.path.join(os.getcwd(), 'simulations_SPD', 'type_i_data_unif', type_i_filename), 'rb') as f:
...
############################################################################################################            
    ...
    new_ts = np.random.uniform(0, 1, MC)
...
############################################################################################################
    ...
    with open(os.path.join(os.getcwd(), 'simulations_SPD', 'type_iii_data_unif', type_iii_filename), 'rb') as f:
...
############################################################################################################            
    ...
    results_filename = os.path.join(os.getcwd(), 'simulations_SPD', 'results_unif', f'{file[:-4]}' + '_results.npy')
    np.save(results_filename, results)

file_list = list(filter(
                lambda file: file.endswith(f'block_{current_block}.pkl') and 
                            not os.path.exists(os.path.join(os.getcwd(), 'simulations_SPD', 'results_unif', f'{file[:-4]}_results.npy')), 
                filter(lambda file: file.endswith('.pkl'), os.listdir(os.path.join(os.getcwd(), 'simulations_SPD', 'data_unif/')))
                    )
                )  
