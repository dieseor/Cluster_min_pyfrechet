...
# for b in {1..50}
# do
#   sbatch --time=04:50:00 -n 1 --cpus-per-task=32 --mem=16GB --mail-type=BEGIN,END,FAIL --mail-user=dieserra@est-econ.uc3m.es --export=block=$b --output="%j-SPD-block$b.out" job_SPD.sh
# done
